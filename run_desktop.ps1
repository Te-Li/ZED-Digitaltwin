...
# python aruco_grid_twin.py live-top --ground-config "markers/ground_desktop/ground_markers.json" --camera-config live_cameras.json --top-marker-size-mm 30.0 --block-height-mm 40.0